...
export default function JournalEntryModelCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setGratitude(initialValues.gratitude);
    setDailyGoals(initialValues.dailyGoals);
    setAffirmation(initialValues.affirmation);
    setAmazingMoment(initialValues.amazingMoment);
    setImprovement(initialValues.improvement);
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new JournalEntryModel(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "JournalEntryModelCreateForm")}
      {...rest}
    >
      <TextField
        label="Date"
